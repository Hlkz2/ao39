...
{
public:
                beast_master() : CreatureScript("beast_master"){ }
        ...
        player->ADD_GOSSIP_ITEM(6, "Araignee.", GOSSIP_SENDER_MAIN, 1);
        ...
        player->ADD_GOSSIP_ITEM(6, "Felin.", GOSSIP_SENDER_MAIN, 7);
        ...
        player->ADD_GOSSIP_ITEM(6, "Phalene.", GOSSIP_SENDER_MAIN, 914);
        ...
        player->ADD_GOSSIP_ITEM(6, "Tortue.", GOSSIP_SENDER_MAIN, 21);
                        ...
                        break;
                        case 8: //Gorille done
                                CreatePet(player, m_creature, 1557);
                        break;
                        case 9: //Haut-trotteur done
