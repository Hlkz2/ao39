...
bool OnGossipHello(Player *player, Creature * m_creature){
                                ...
                                player->ADD_GOSSIP_ITEM(6, "Regalien / Sombrebrume...", GOSSIP_SENDER_MAIN, 250);
...
l150 :
    case 150:
        ...
        player->ADD_GOSSIP_ITEM(6, "Spalieres de Revelosh.", GOSSIP_SENDER_MAIN, 153);
        player->ADD_GOSSIP_ITEM(6, "Gants de Revelosh.", GOSSIP_SENDER_MAIN, 154);
        player->ADD_GOSSIP_ITEM(6, "Poignets deterres.", GOSSIP_SENDER_MAIN, 155);
        player->ADD_GOSSIP_ITEM(6, "Chevaliere d'aigue marine.", GOSSIP_SENDER_MAIN, 156);
	...
	break;
	    case 152:
			player->AddItem(9388, 1);
			goto l150;
		break;
	    case 153:
			player->AddItem(9389, 1);
			goto l150;
		break;
	    case 154:
			player->AddItem(9390, 1);
			goto l150;
		break;
	    case 155:
			player->AddItem(9428, 1);
			goto l150;
		break;
	    case 156:
			player->AddItem(20964, 1);
			goto l150;
		break;
	    case 157:
			player->AddItem(9409, 1);
			goto l150;
		break;
	    case 158:
			player->AddItem(10504, 1);
			goto l150;
		break;
...
l200 :
	...
	break;
	    case 202:
			player->AddItem(7524, 1);			
			goto l200;
		break;
	    case 203:
			player->AddItem(7544, 1);
			goto l200;
		break;
	    case 204:
			player->AddItem(7533, 1);
			goto l200;
		break;
	    case 205:
			player->AddItem(14261, 1);
			goto l200;
		break;
	    case 206:
			player->AddItem(14260, 1);
			goto l200;
		break;
	    case 207:
			player->AddItem(15156, 1);
			goto l200;
		break;
	    case 208:
			player->AddItem(15592, 1);
			goto l200;
		break;
	    case 209:
		...
		break;
	    case 210:
			player->AddItem(5215, 1);
			goto l200;
		break;
	    case 211:
			player->AddItem(3187, 1);
			goto l200;
		break;
		
/////////////////////// REGALIEN/SOMBREBRUME /////////////////////////////

l250 :
    case 250:
        player->ADD_GOSSIP_ITEM(6, "Jambieres regaliennes", GOSSIP_SENDER_MAIN, 252);
        player->ADD_GOSSIP_ITEM(6, "Chapeau de sorcier regalien.", GOSSIP_SENDER_MAIN, 253);
        player->ADD_GOSSIP_ITEM(6, "Gants regaliens.", GOSSIP_SENDER_MAIN, 254);
        player->ADD_GOSSIP_ITEM(6, "Bottes regaliennes.", GOSSIP_SENDER_MAIN, 255);
        player->ADD_GOSSIP_ITEM(6, "Mantelet regalien.", GOSSIP_SENDER_MAIN, 256);
        player->ADD_GOSSIP_ITEM(6, "Cape regalienne.", GOSSIP_SENDER_MAIN, 257);
        player->ADD_GOSSIP_ITEM(6, "Crispins regaliens.", GOSSIP_SENDER_MAIN, 258);
        player->ADD_GOSSIP_ITEM(6, "Echarpe regalienne.", GOSSIP_SENDER_MAIN, 259);
        player->ADD_GOSSIP_ITEM(6, "Etoile regalienne.", GOSSIP_SENDER_MAIN, 260);
	...
	break;
	    case 252:
			player->AddItem(7469, 1);
			goto l250;
		break;
	    case 253:
			player->AddItem(7470, 1);
			goto l250;
		break;
	    case 254:
			player->AddItem(7471, 1);
			goto l250;
		break;
	    case 255:
			player->AddItem(7472, 1);
			goto l250;
		break;
	    case 256:
			player->AddItem(7473, 1);
			goto l250;
		break;
	    case 257:
			player->AddItem(7474, 1);
			goto l250;
		break;
	    case 258:
			player->AddItem(7475, 1);
			goto l250;
		break;
	    case 259:
		...
		break;
	    case 260:
			player->AddItem(7555, 1);
			goto l250;
		break;
	    case 261:
			player->AddItem(14246, 1);
			goto l250;
		break;
	    case 262:
			player->AddItem(14242, 1);
			goto l250;
		break;
	    case 263:
			player->AddItem(14243, 1);
			goto l250;
		break;
	    case 264:
			player->AddItem(14238, 1);
			goto l250;
		break;
	    case 265:
			player->AddItem(14241, 1);
			goto l250;
		break;
	    case 266:
			player->AddItem(14245, 1);
			goto l250;
		break;
	    case 267:
			player->AddItem(14240, 1);
			goto l250;
		break;
	    case 268:
			player->AddItem(14239, 1);
			goto l250;
		break;
...
l300 :
    case 300:
        ...
        player->ADD_GOSSIP_ITEM(6, "Protege-epaules denombres.", GOSSIP_SENDER_MAIN, 308);
        ...
        player->ADD_GOSSIP_ITEM(6, "Spalieres vigoureuses.", GOSSIP_SENDER_MAIN, 307);
        ...
        player->ADD_GOSSIP_ITEM(6, "Garde-epaules lies a la terre.", GOSSIP_SENDER_MAIN, 309);
	...
	break;
		...
		break;
	    case 303:
			player->AddItem(51965, 1);			
			goto l300;
		break;
	    case 304:
			player->AddItem(51973, 1);			
			goto l300;
		break;
	    case 305:
			player->AddItem(51980, 1);			
			goto l300;
		break;
	    case 306:
		...
		break;
	    case 307:
			player->AddItem(51966, 1);			
			goto l300;
		break;
	    case 308:
			player->AddItem(51974, 1);			
			goto l300;
		break;
	    case 309:
			player->AddItem(51976, 1);			
			goto l300;
		break;
	    case 310:
		...
		break;
	    case 311:
			player->AddItem(51968, 1);			
			goto l300;
		break;
	    case 312:
			player->AddItem(51964, 1);			
			goto l300;
		break;
	    case 313:
			player->AddItem(51978, 1);			
			goto l300;
		break;
...
l400 :
	...
	break;
	    case 402:
			player->AddItem(9906, 1);
			goto l400;
		break;
	    case 403:
			player->AddItem(9907, 1);
			goto l400;
		break;
	    case 404:
			player->AddItem(9908, 1);
			goto l400;
		break;
	    case 405:
			player->AddItem(9909, 1);
			goto l400;
		break;
	    case 406:
			player->AddItem(9910, 1);
			goto l400;
		break;
	    case 407:
			player->AddItem(14247, 1);
			goto l400;
		break;
	    case 408:
			player->AddItem(14253, 1);
			goto l400;
		break;
	    case 409:
			player->AddItem(14250, 1);
			goto l400;
		break;
	    case 410:
			player->AddItem(14248, 1);
			goto l400;
		break;
	    case 411:
			player->AddItem(14255, 1);
			goto l400;
		break;
...
l500 :
    case 550:
        ...
        player->ADD_GOSSIP_ITEM(6, "Jambieres de capitaine.", GOSSIP_SENDER_MAIN, 553);
        ...
        player->ADD_GOSSIP_ITEM(6, "Garde-epaules de capitaine.", GOSSIP_SENDER_MAIN, 557);
	...
	break;
	    case 552:
			player->AddItem(7486, 1);
			goto l500;
		break;
	    case 553:
			player->AddItem(7487, 1);
			goto l500;
		break;
	    case 554:
			player->AddItem(7488, 1);
			goto l500;
		break;
	    case 555:
			player->AddItem(7489, 1);
			goto l500;
		break;
	    case 556:
		...
		break;
	    case 562:
			player->AddItem(9932, 1);
			goto l500;
		break;
	    case 563:
			player->AddItem(9934, 1);
			goto l500;
		break;
	    case 564:
			player->AddItem(9926, 1);
			goto l500;
		break;
	    case 565:
			player->AddItem(9930, 1);
			goto l500;
		break;
	    case 566:
			player->AddItem(9931, 1);
			goto l500;
		break;
	    case 567:
			player->AddItem(9927, 1);
			goto l500;
		break;
	    case 568:
			player->AddItem(9929, 1);
			goto l500;
		break;
...
l600 :
    case 600:
        ...
        player->ADD_GOSSIP_ITEM(6, "Jambieres de chevaucheur de loup.", GOSSIP_SENDER_MAIN, 606);
        player->ADD_GOSSIP_ITEM(6, "Protege-epaules de chevaucheur...", GOSSIP_SENDER_MAIN, 607);
        player->ADD_GOSSIP_ITEM(6, "Protege-poignets de chevaucheur...", GOSSIP_SENDER_MAIN, 608);
        player->ADD_GOSSIP_ITEM(6, "Jambieres de forestier.", GOSSIP_SENDER_MAIN, 609);
	...
	break;
	    case 602:
			player->AddItem(15369, 1);
			goto l600;
		break;
	    case 603:
			player->AddItem(15370, 1);
			goto l600;
		break;
	    case 604:
			player->AddItem(15371, 1);
			goto l600;
		break;
	    case 605:
			player->AddItem(15372, 1);
			goto l600;
		break;
	    case 606:
			player->AddItem(15374, 1);
			goto l600;
		break;
	    case 607:
			player->AddItem(15375, 1);
			goto l600;
		break;
	    case 608:
			player->AddItem(15377, 1);
			goto l600;
		break;		
	    case 609:
...
l700 :
    case 700:
        player->ADD_GOSSIP_ITEM(6, "Drape de sorcier.", GOSSIP_SENDER_MAIN, 702);
	...
	break;
	    case 702:
			player->AddItem(9874, 1);
			goto l700;
		break;
	    case 703:
			player->AddItem(9882, 1);
			goto l700;
		break;
	    case 704:
			player->AddItem(9884, 1);
			goto l700;
		break;
	    case 705:
			player->AddItem(9883, 1);
			goto l700;
		break;
	    case 706:
			player->AddItem(9878, 1);
			goto l700;
		break;
	    case 707:
			player->AddItem(9881, 1);
			goto l700;
		break;
	    case 708:
			player->AddItem(9876, 1);
			goto l700;
		break;
	    case 709:
			player->AddItem(9880, 1);
			goto l700;
		break;
	    case 710:
			player->AddItem(9875, 1);
			goto l700;
		break;
	    case 711:
			player->AddItem(9879, 1);
			goto l700;
		break;
	    case 712:
			player->AddItem(9877, 1);
			goto l700;
		break;
...
l800 :
	...
	break;
	    case 802:
			player->AddItem(9916, 1);
			goto l800;
		break;
	    case 803:
			player->AddItem(9917, 1);
			goto l800;
		break;
	    case 804:
			player->AddItem(9920, 1);
			goto l800;
		break;
	    case 805:
			player->AddItem(9925, 1);
			goto l800;
		break;
	    case 806:
			player->AddItem(9919, 1);
			goto l800;
		break;
	    case 807:
			player->AddItem(15169, 1);
			goto l800;
		break;
	    case 808:
			player->AddItem(15161, 1);
			goto l800;
		break;
	    case 809:
			player->AddItem(15163, 1);
			goto l800;
		break;
	    case 810:
			player->AddItem(15165, 1);
			goto l800;
		break;
...
l900 :
	...
	break;
	    case 902:
			player->AddItem(15599, 1);
			goto l900;
		break;
	    case 903:
			player->AddItem(15607, 1);
			goto l900;
		break;
	    case 904:
			player->AddItem(15608, 1);
			goto l900;
		break;
	    case 905:
		...
		break;
	    case 906:
			player->AddItem(15605, 1);
			goto l900;
		break;
	    case 907:
			player->AddItem(15603, 1);
			goto l900;
		break;
	    case 908:
		...
		break;
	    case 909:
			player->AddItem(15612, 1);
			goto l900;
		break;
	    case 910:
			player->AddItem(15610, 1);
			goto l900;
		break;
	    case 911:
			player->AddItem(15611, 1);
			goto l900;
		break;
	    case 912:
			player->AddItem(15613, 1);
			goto l900;
		break;
...
l950 :
    case 950:
        ...
        player->ADD_GOSSIP_ITEM(6, "Jambieres de veneur.", GOSSIP_SENDER_MAIN, 959);
        player->ADD_GOSSIP_ITEM(6, "Epaulieres de veneur.", GOSSIP_SENDER_MAIN, 960);
        player->ADD_GOSSIP_ITEM(20, "= Retour =", GOSSIP_SENDER_MAIN, 100);
        player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
	break;
	    case 952:
			player->AddItem(9885, 1);
			goto l950;
		break;
	    case 953:
			player->AddItem(9886, 1);
			goto l950;
		break;
	    case 954:
			player->AddItem(9887, 1);
			goto l950;
		break;
	    case 955:
			player->AddItem(9889, 1);
			goto l950;
		break;
	    case 956:
			player->AddItem(9890, 1);
			goto l950;
		break;
	    case 957:
			player->AddItem(9891, 1);
			goto l950;
		break;
	    case 958:
			player->AddItem(9892, 1);
			goto l950;
		break;
	    case 959:
			player->AddItem(9893, 1);
			goto l950;
		break;
	    case 960:
			player->AddItem(9894, 1);
			goto l950;
		break;
		}
                return true;
